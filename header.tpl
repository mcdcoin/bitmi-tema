...
<head>
  ...
  <title>{if $kbarticle.title}{$kbarticle.title} - {/if}{$pagetitle} - {$companyname}</title>
	...
	<link rel="stylesheet" type="text/css" href="templates/{$template}/assets/css/main.css" />
		<link rel="apple-touch-icon" sizes="57x57" href="templates/{$template}/assets/img/apple-icon-57x57.png">
		<link rel="apple-touch-icon" sizes="60x60" href="templates/{$template}/assets/img/apple-icon-60x60.png">
		<link rel="apple-touch-icon" sizes="72x72" href="templates/{$template}/assets/img/apple-icon-72x72.png">
		<link rel="apple-touch-icon" sizes="76x76" href="templates/{$template}/assets/img/apple-icon-76x76.png">
		<link rel="apple-touch-icon" sizes="114x114" href="templates/{$template}/assets/img/apple-icon-114x114.png">
		<link rel="apple-touch-icon" sizes="120x120" href="templates/{$template}/assets/img/apple-icon-120x120.png">
		<link rel="apple-touch-icon" sizes="144x144" href="templates/{$template}/assets/img/apple-icon-144x144.png">
		<link rel="apple-touch-icon" sizes="152x152" href="templates/{$template}/assets/img/apple-icon-152x152.png">
		<link rel="apple-touch-icon" sizes="180x180" href="templates/{$template}/assets/img/apple-icon-180x180.png">
		<link rel="icon" type="image/png" sizes="192x192"  href="templates/{$template}/assets/img/android-icon-192x192.png">
		<link rel="icon" type="image/png" sizes="32x32" href="templates/{$template}/assets/img/favicon-32x32.png">
		<link rel="icon" type="image/png" sizes="96x96" href="templates/{$template}/assets/img/favicon-96x96.png">
		<link rel="icon" type="image/png" sizes="16x16" href="templates/{$template}/assets/img/favicon-16x16.png">
		<link rel="manifest" href="templates/{$template}/assets/img/manifest.json">
		<meta name="msapplication-TileImage" content="templates/{$template}/assets/img/ms-icon-144x144.png">
							...
							<div class="hostingMenu">
								<div class="miniSirket">
									<ul>
										...
										<li><a href="tel:+908500000000">Ara: 0541 738 03 12</a></li>
										<li><a href="contact.php">İletişim</a></li>
									</ul>
								</div>
								<div class="menu">
									<ul class="dmMenu">
										<li class="title"><i class="fa fa-linux"></i> <span>Oyunlar</span></li>
									...
									<ul class="dmMenu">
										<li class="title"><i class="fa fa-windows"></i> <span>Oyunlar</span></li>
